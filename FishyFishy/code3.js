...
gdjs.SplashCode.asyncCallback13836148 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(6), (runtimeScene) => (gdjs.SplashCode.asyncCallback13836148(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.SplashCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13834916);
}
